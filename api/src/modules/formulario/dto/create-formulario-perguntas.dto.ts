import { CreatePerguntaDto } from '../../pergunta/dto/create-pergunta.dto';
import { CreateFormularioDto } from './create-formulario.dto';
import { IsString, Length, IsBoolean, IsOptional, IsArray } from 'class-validator';

export class CreateFormularioPerguntasDto extends CreateFormularioDto {
